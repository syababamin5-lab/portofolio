...
### DATA PRIBADI
- **Nama Lengkap** : Syabaab Amin Amanullah, S.E.
...
*Sarjana Akuntansi (S.E.)* | 2018 – 2021 | IPK : 3,72
...
**HIMPUNAN MAHASISWA AKUNTANSI (HIMAKSI) STIE PASUNDAN BANDUNG**  
*Ketua Umum* | 2019 – 2020
- Mengoordinasikan kepengurusan organisasi mahasiswa akuntansi.
- Mengelola pelaksanaan program kerja organisasi bersama pengurus.
- Mengoordinasikan pelaksanaan STIEPAS Accounting Competition (SAC) tingkat Bandung Raya bagi siswa SMK.
- Berkoordinasi dengan peserta, sekolah, dosen, dan panitia dalam pelaksanaan kegiatan.
...
- Microsoft Word, Microsoft PowerPoint, Google Workspace
- Siskeudes
...
### INFORMASI TAMBAHAN
- Bersedia bekerja di Bandung.
- Terbiasa bekerja dengan dokumen, data, dan proses administrasi yang membutuhkan ketelitian tinggi.
- Mampu bekerja secara individu maupun dalam tim.
- Memiliki ketertarikan pada audit internal, tata kelola, pengendalian risiko, dan perbaikan proses bisnis.
- Memiliki kemampuan belajar yang cepat terhadap prosedur, sistem, dan standar kerja baru.
